...
public class Calculo {
    ...
    public Calculo(ConsultaConversion conversion) {
    ...
    public String obtenerMensajeRespuesta() {
        String mensaje = getCantidad() + " " + getMonedaBase().toUpperCase() + " equivale a: " + conversion.buscaConversion(getMonedaBase(), getMonedaObjetivo(), getCantidad()) + " " + getMonedaObjetivo().toUpperCase();
