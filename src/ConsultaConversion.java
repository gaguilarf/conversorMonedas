...
// Realiza las consultas a una API para obtener las tasas de cambio.
public class ConsultaConversion {
    public String buscaConversion(String monedaBase, String monedaObjetivo, double cantidad) {
        try {
            URI direccion = URI.create("https://v6.exchangerate-api.com/v6/0f8e8d0f40046915a48ccf05/pair/" +
